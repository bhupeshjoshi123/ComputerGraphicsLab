...
function setup() {
    ...
    cohenSutherland({ x: 26, y: 175 }, { x: 210, y: 450 }, clipping_window);
    cohenSutherland({ x: 150, y: 220 }, { x: 310, y: 370 }, clipping_window);
    cohenSutherland({ x: 500, y: 110 }, { x: 210, y: 370 }, clipping_window);
